        ...
        `}
            >
                <div className="flex flex-col justify-between h-full p-4">
                    <div className={`flex flex-col space-y-4 ${collapsed ? 'items-center' : ''}`}>
                        <div className={`flex ${collapsed ? 'justify-center' : 'justify-between'} items-center w-full`}>
                            {!collapsed && (
                                <div className="flex items-center gap-1 text-primary-studio font-medium text-sm">
                                    <Image src="/dashboard/logo-tumbuhin.svg" alt="Logo" width={45} height={45} />
                            ...
                            <button onClick={() => setCollapsed(!collapsed)} className="cursor-pointer hidden md:block">
                                <Image
                                    src={collapsed ? '/dashboard/icons/arrow-right.svg' : '/dashboard/icons/arrow-left.svg'}
                                    alt="toggle"
                                    width={28}
                                    height={28}
                                />
                        ...
                        {!collapsed && <h2 className="text-base text-gray-500 mb-2">Operations</h2>}
